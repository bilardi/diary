...
Same lightweight setup as [github-actions-publish](https://github.com/bilardi/github-actions-publish): `ANN` enforces type annotations (PEP 484), docstrings follow PEP 257 by hand, line length is left to the formatter.
